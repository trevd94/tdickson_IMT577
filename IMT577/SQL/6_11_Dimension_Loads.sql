...
CREATE OR REPLACE TABLE Dim_Store(
    ...
    ,DimLocationID INT CONSTRAINT FK_DimStoreDimLocation FOREIGN KEY
        REFERENCES Dim_Location (DimLocationID) NOT NULL --Surrogate Key
...
CREATE OR REPLACE TABLE Dim_Reseller(
    ...
    ,DimLocationID INT CONSTRAINT FK_DimResellerDimLocation FOREIGN KEY
        REFERENCES Dim_Location (DimLocationID) NOT NULL --Surrogate Key
...
CREATE OR REPLACE TABLE Dim_Customer(
    ...
    ,DimLocationID INT CONSTRAINT FK_DimCustomerDimLocation FOREIGN KEY
        REFERENCES Dim_Location (DimLocationID) NOT NULL --Surrogate Key
...
(
    ...
    ON S.Address = DL.Address
    AND S.City = DL.City
    and S.StateProvince = DL.State_Province
...
(
    ...
    JOIN DIM_LOCATION DL
    ON R.Address = DL.Address
    AND R.City = DL.City
    and R.StateProvince = DL.State_Province
...
(
    ...
    JOIN DIM_LOCATION DL
    ON C.Address = DL.Address
    AND C.City = DL.City
    and C.StateProvince = DL.State_Province
